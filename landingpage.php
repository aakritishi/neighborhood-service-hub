...
<body>
    <body>
        ...
        <nav class="main-menu">
            <ul>
                <p style="font-size:1.2rem; position:relative; left:0.8rem; font-weighht:bolder; font-family:sans-serif; color:white;">Neighborhood Service Hub</p>
            <li>
        ...
        <div class="post">
            <ul>
                <li><a href="./service/servicepost.html"><button>Post</button></a></li>
        ...
        <?php
            require "./service/servicecard.html";
        ?>
        </div>
